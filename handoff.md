...
| # | 설명 | 우선순위 | 영향 |
|---|------|:---:|------|
| **#62 v2.3** | weekly-kpi WHERE 절 `ship_plan_date → finishing_plan_end` 원안 복원 (factory.py L322 1줄 교정) | 🟠 MEDIUM | 주간 production_count 등 숫자 자동 변경, FE 코드 변경 0 |
...
| 우선 | 작업 | 시간 |
|:---:|:---|:---:|
| 1 | **REF-V-00-UTIL** — `formatDate` 공통 유틸 승격 | 30분 |
| 2 | **BUG-V2** — ProductionPerformancePage `?? []` 7개소 | 1h |
| 3 | **AnalyticsDashboardPage** — usage_minutes → last_access | 30분 |
| 4 | **REF-V-01** — ProductionPerformancePage 895줄 분할 | 반나절 |
| 5 | **REF-V-02** — QrManagementPage 814줄 분할 | 반나절 |
