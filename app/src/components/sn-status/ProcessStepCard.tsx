  ...
  return (
    ...
    >
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: workers.length > 0 || hasChecklist ? '10px' : '0', gap: '6px' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '6px', flexWrap: 'wrap' }}>
          ...
          {categoryPartner && categoryPartner.trim().length > 0 && (
            <span style={{ fontSize: '13px', fontWeight: 500, color: 'var(--gx-steel)' }}>
              · {categoryPartner}
            </span>
          )}
          {/* 강제종료 뱃지 */}
      ...
      {workers.length === 0 && !hasChecklist && (
        <div style={{ fontSize: '13px', color: 'var(--gx-silver)' }}>대기중</div>
      )}
      {workers.length > 0 && (
            ...
            return (
              ...
              >
                <span style={{ color: 'var(--gx-slate)', fontWeight: 500, minWidth: '56px' }}>
                  ...
                  {w.task_name && (
                    <span style={{ color: 'var(--gx-silver)', fontWeight: 400, fontSize: '11px', marginLeft: '4px' }}>
                      {w.task_name}
                    </span>
                  )}
                </span>
      ...
      {checklistLoading && (
        <div style={{
          padding: '8px 0', fontSize: '12px', color: 'var(--gx-steel)',
      ...
      {hasChecklist && (
        <div style={{
          ...
          >
            ...
            <span style={{ fontSize: '12px', fontFamily: "'JetBrains Mono', monospace", color: checklist.summary?.percent === 100 ? 'var(--gx-success)' : 'var(--gx-slate)' }}>
      ...
      {forceCloseTarget && (
        ...
        >
          ...
          >
            <h3 style={{ fontSize: '16px', fontWeight: 600, color: 'var(--gx-charcoal)', margin: '0 0 16px' }}>
              강제 종료
            </h3>
            <div style={{ fontSize: '13px', color: 'var(--gx-slate)', marginBottom: '16px' }}>
              {maskName(forceCloseTarget.workerName)} 작업을 강제 종료합니다.
            </div>
            <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
              <div>
                <label style={{ fontSize: '13px', fontWeight: 600, color: 'var(--gx-steel)', display: 'block', marginBottom: '4px' }}>
                  사유 *
                </label>
                <textarea
                  ...
                  style={{
                    ...
                    border: '1px solid var(--gx-mist)', fontSize: '14px',
            ...
            <div style={{ display: 'flex', justifyContent: 'flex-end', gap: '8px', marginTop: '20px' }}>
              <button
                ...
                style={{
                  ...
                  background: 'var(--gx-white)', color: 'var(--gx-slate)', fontSize: '14px', cursor: 'pointer',
                }}
              >취소</button>
              <button
