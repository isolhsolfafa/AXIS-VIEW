...
└── docs/                     ← 설계 문서
    ...
    ├── concepts/                  컨셉 HTML 모음
    └── sprints/
        ├── DESIGN_FIX_SPRINT.md          Sprint 1~26 (메인 스프린트 문서)
...
| `docs/sprints/DESIGN_FIX_SPRINT.md` | Sprint 1~26 메인 스프린트 문서 | 필수 |
