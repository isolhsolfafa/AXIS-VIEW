...
## v1.29.0: QR 관리 전장협력사 컬럼 + 필터 — ✅ 완료 (2026-04-16)

- QR 관리 테이블에 전장협력사 컬럼 추가
- 전장협력사 드롭다운 필터 (데이터 자동 추출)
- 전장시작 필터 + 전장협력사 필터 조합으로 업체별 조회

---

## v1.28.0: 생산일정 업체 필터 + 체크리스트 ELEC 수정 — ✅ 완료 (2026-04-15)

- 생산일정: 기구업체/전장업체 드롭다운 필터
- 체크리스트 관리: ELEC COMMON 자동, 자물쇠 제거, BE 등장 순서 정렬, 그룹 내 순번
